...
<div class="pagination">
  ...
  {% if paginator.previous %}
    <li class="prev"><a href="{{ BASE_PATH }}{{ paginator.previous.url }}" title="{{ paginator.previous.title }}">&larr; Previous</a></li>
  {% else %}
    <li class="prev disabled"><a>&larr; Previous</a></li>
  {% endif %}
    <li><a href="{{ BASE_PATH }}{{ site.JB.archive_path }}">Archive</a></li>
  {% if paginator.next %}
    <li class="next"><a href="{{ BASE_PATH }}{{ paginator.next.url }}" title="{{ paginator.next.title }}">Next &rarr;</a></li>
  {% else %}
