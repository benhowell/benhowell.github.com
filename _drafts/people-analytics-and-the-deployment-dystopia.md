...
<div class="intro">
  <div class="intro-txt">
    ...
    <p>
    People analytics, also referred to as workforce analytics and corporate analytics when applied to management, is the application of analytics on big data sets to create behavioural and social profiles for individual people.
    </p>
    <p>
