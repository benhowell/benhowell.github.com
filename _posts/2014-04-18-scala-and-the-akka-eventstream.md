...
<p>
In the next few articles we'll look at some <span markdown="span">[alternative implementations]({% post_url 2014-04-23-scala-and-the-akka-event-bus %})</span> using <span markdown="span">[Scala][1] and [Akka][2]</span>, 
</p>
</div> 
