...
<div class="intro">
  ...
  Publish/Subscribe (aka: pub/sub) is a messaging pattern that helps <span>decouple[^1]</span> the sender and receiver of messages. Generally, this pattern is used across network(s) and provides ease of scalability and dynamic network topologies. 
