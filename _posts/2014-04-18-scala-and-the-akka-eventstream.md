...
<p>
In the next few articles we'll look at some using <span markdown="span">[Scala][1] and [Akka][2]</span>, such as this: [Publish/Subscribe using Scala and Akka EventBus]({% post_url 2014-04-23-scala_and_the_akka_event_bus %})
</p>
</div> 
