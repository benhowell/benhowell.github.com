...
###Publish/Subscribe
Publish–subscribe is a messaging pattern that helps decouple[1]({% post_url 2014-04-18-scala-and-the-akka-event-stream %}) the sender and receiver of messages. 
